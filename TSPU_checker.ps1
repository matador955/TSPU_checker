...
# =========================================================
$Count       = 120               # Сколько случайных IP из /24 проверять. Больше = точнее картина, но дольше прогон.
...
$WebExchangeMs = 2000           # Таймаут на веб-ОБМЕН (TLS-рукопожатие на 443, чтение ответа на 80). Больше $TimeoutMs, т.к. рукопожатие занимает несколько кругов; на медленных/дальних хостах увеличьте.
# =========================================================
